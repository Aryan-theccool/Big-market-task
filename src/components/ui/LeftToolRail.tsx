...
const TOOLS = [
  ...
  { id: 'draw',        label: 'Pencil (Draw)', shortcut: 'D', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M17 3a2.828 2.828 0 114 4L7.5 20.5 2 22l1.5-5.5L17 3z"/></svg> },
  ...
  { id: 'handwriting', label: 'Cursive Text',  shortcut: 'W', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M3 15c2 0 4-4 6-4s4 4 6 4 4-4 6-4"/><path d="M12 5v14M8 9h8"/></svg> },
