    ...
    >
      ...
      <div className="flex items-center gap-2 min-w-0">
        <Link
          href="/"
          title="Back to home"
          className="flex h-7 w-7 items-center justify-center rounded-[8px] text-[var(--text-secondary)] transition-all hover:bg-[var(--bg-hover)] active:scale-95 shrink-0"
        >
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          style={{ background: store.viewMode !== 'canvas' ? 'var(--accent-glow)' : 'transparent', color: store.viewMode !== 'canvas' ? 'var(--accent)' : 'currentColor' }}
        >
